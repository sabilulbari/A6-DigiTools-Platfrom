...
const Workflow = () => {
  return (
    <div className=" bg-linear-to-r from-[#4F39F6] to-[#9514FA] py-16">
      <div className="text-center space-y-6 lg:px-[200px] py-[120px] w-[90%] mx-auto">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 ">
          ...
          <button className="bg-transparent border border-white  text-white rounded-full py-3 px-12 ">View Pricing</button>
        </div>
